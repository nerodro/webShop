...
namespace WebShoping.Models
{
    public class GeneralContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            string productPcName = "Зве рь пк";
            ...
            //Cart cart = new Cart {Id = 5, NameProduct = productPcName, Price = pricePc, Count = countPc, ProductId = 2};
           ...
           // modelBuilder.Entity<Cart>().HasData(new Cart[] { cart });
